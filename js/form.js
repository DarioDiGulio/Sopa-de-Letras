...
const setWordsWithKeyboard = (event) => {
debugger
  if (event.which == 13 && getId('inputWords').value) {
...
const setDimensions = (event) => getId('dimensionValue').innerText = event.target.value;
